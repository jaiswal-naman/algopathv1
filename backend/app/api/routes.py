...
class SubmitAnswersResponse(BaseModel):
    """Response after submitting answers with generated LFA."""
    session_id: str
    phase: str
    lfa_document: dict
    mermaid_code: str
        ...
        if self._orchestrator is None:
            with self._lock:
                ...
                if self._orchestrator is None:
                    ...
                    self._orchestrator = LFAOrchestrator(api_key)
...
async def submit_answers(
    ...
    """
    Submit answers to clarifying questions and generate LFA.

    Phase 3: Finalization - Generate custom LFA based on answers

    Returns the generated LFA document and visualization.
    """
    try:
        orchestrator = get_orchestrator()
        ...
        # Submit answers and generate LFA directly
        state = orchestrator.submit_answers_and_generate(state, answers_list)
